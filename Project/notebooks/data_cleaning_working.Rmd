...
# Check for leading/trailing whitespace
city_ws <-
  sum(stringr::str_detect(ad_clean$DEVICE_GEO_CITY, "^\\s|\\s$"),
      na.rm = TRUE)
...
**Observations**
  ...
  - There are no rows with whitespace in the city name.
