...
### Summary
  ...
  - `PRICE` was recorded as `character` and contained a mix of plain decimals, scientific notation, one obvious `"O"` $\to$ `"0"` typo, sentinel `-999` values, and negative prices with plausible magnitudes.  
