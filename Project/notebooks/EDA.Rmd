...
# Data
# source("../scripts/final_data_cleaning.R")
```
...
# so I left it out.
ggpairs(cumulative_ad_data[, c("DEVICE_TYPE", "DEVICE_GEO_ZIP", "PRICE", "RESPONSE_TIME", "DEVICE_GEO_LAT", "DEVICE_GEO_LONG")])
...
# Boxplot
ggplot(cumulative_ad_data, aes(x = cumulative_ad_data$BID_WON, y = cumulative_ad_data$PRICE)) + 
    geom_boxplot(
        fill = "#FF7F50",
        color = "black",
        outlier.color = "red",
