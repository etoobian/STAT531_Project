...
## Roles & Responsibilities  (Just a start, refine as needed)

- **Chris** — EDA, visualizations, guiding question refinement
- **Takeshi** — Cleaning, documentation, 
- **Esther** — GitHub coordination, project structure, reproducibility workflow, cleaning, EDA, final presentation
- **Khloud** — Cleaning, ...

## Coordination Tools  (add details from team docs)

- **GitHub:** Feature branches → PRs → reviews → merge  
- **Jira / Kanban:** Task assignments, subtasks, progress tracking  
- **Commit Habits:** Small atomic commits, descriptive messages
...
Use this slide to emphasize collaboration practices, not code.
:::
...
::: notes
Professor's Section 3.1 — Key Issues You Found.
Goal: show variety and importance of issues before deep-diving.
:::

---

# Issue 1: (Replace With Real Issue Title)

## What We Observed

- Brief description of the issue  
  (for example: "Longitude values shifted by +10 degrees for a subset of rows")  
...
# Issue 2: (Replace With Real Issue Title)

## What We Observed (Problem)

- Brief description of the second issue  
  (for example: "Inconsistent device types due to typos and mixed casing")  

## Why It Matters

- Breaks grouping and summarization  
- Makes plots and tables harder to interpret  
- Reduces comparability across analyses

## Cleaning Strategy  (Fix Summary)

- Principle: standardize categories while preserving information  
- Implementation: string normalization and recoding with case_when  
- Documentation of recoding decisions for reproducibility
...
Repeat this pattern for all Issues if needed, or
combine smaller issues on a single slide.
:::
...
- Ensure clear labels, good color choices, no clutter and interpretation w/ each visual
This slide uses side-by-side layout for plots and narrative.
:::
...
- Mention how cleaning decisions (e.g., device-type standardization)
  were necessary for this figure to be meaningful  
...
- Mention uncertainties or next steps
Keep bullets crisp and non-technical.
:::
