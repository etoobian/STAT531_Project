...
knitr::opts_knit$set(root.dir = "C:/Users/inkud/Desktop/STAT 531/STAT531_Project")
```
...
ungroup(filter(.data=summarize(.data=group_by(.data=filter(.data=temp_ad_data, DEVICE_GEO_LAT %in% lat_of_has_over_long_val), DEVICE_GEO_LAT, DEVICE_GEO_ZIP), n=n_distinct(DEVICE_GEO_LONG)), n>2))
