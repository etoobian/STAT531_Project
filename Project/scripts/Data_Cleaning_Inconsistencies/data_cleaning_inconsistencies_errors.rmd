...
#---- Newer code that you use for this R-markdown file.a
base_data_path = file.path(dirname(dirname(getwd())), "data/bids_data_vDTR.parquet")
base_data_path # Verify that the file path.
